...
func (o *Oracle) atOpen(conn dialect.ExecQuerier) (migrate.Driver, error) {
	panic("implement me")
}

func (o *Oracle) atTable(t1 *Table, t2 *schema.Table) {
	panic("implement me")
}

func (o *Oracle) atTypeC(column *Column, column2 *schema.Column) error {
	panic("implement me")
}

func (o *Oracle) atUniqueC(table *Table, column *Column, table2 *schema.Table, column2 *schema.Column) {
	panic("implement me")
}

func (o *Oracle) atIncrementC(table *schema.Table, column *schema.Column) {
	panic("implement me")
}

func (o *Oracle) atIncrementT(table *schema.Table, i int64) {
	panic("implement me")
}

func (o *Oracle) atIndex(index *Index, table *schema.Table, index2 *schema.Index) error {
	panic("implement me")
}

func (o *Oracle) atTypeRangeSQL(t ...string) string {
	panic("implement me")
}

func (o *Oracle) supportsDefault(*Column) bool {
	// Oracle supports default values for all standard types.
	return true
}

func (o *Oracle) init(ctx context.Context) error {
	rows := &sql.Rows{}
	if err := o.Query(ctx, "select * from v$version", []interface{}{}, rows); err != nil {
...
func (o *Oracle) tableExist(ctx context.Context, conn dialect.ExecQuerier, name string) (bool, error) {
...
func (o *Oracle) setRange(ctx context.Context, conn dialect.ExecQuerier, t *Table, value int64) error {
